...
const components: Components = {
  ...
  h2: ({ children }) => <h3 className="mt-8 scroll-mt-24 text-xl font-bold text-slate-900 first:mt-0">{children}</h3>,
  h3: ({ children }) => <h4 className="mt-6 text-lg font-semibold text-slate-900">{children}</h4>,
